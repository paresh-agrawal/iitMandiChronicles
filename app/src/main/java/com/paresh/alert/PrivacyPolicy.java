...
public class PrivacyPolicy extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            tv_privacy_policy.setText(Html.fromHtml("<h2>Privacy Policy</h2> <p>  built the IIT Mandi Chronicles app as a Free app. This SERVICE is provided by\n" +
                    ...
                    "    accessible at IIT Mandi Chronicles unless otherwise defined in this Privacy Policy.\n" +
                    "</p> <p><strong>Information Collection and Use</strong></p> <p>For a better experience, while using our Service, I may require you to provide us with certain\n" +
                    "    personally identifiable information, including but not limited to We take Gmail access of user along with their username and display picture of Gmail. Also we ask for access of phone storage and calendar.. The information that I request will be retained on your device and is not collected by me in any way.\n" +
                    ...
                    "        Privacy Policy Generator</a></p>", Html.FROM_HTML_MODE_COMPACT));
        } else {
            tv_privacy_policy.setText(Html.fromHtml("<h2>Privacy Policy</h2> <p>  built the IIT Mandi Chronicles app as a Free app. This SERVICE is provided by\n" +
                    "    at no cost and is intended for use as is.\n" +
                    "</p> <p>This page is used to inform visitors regarding my policies with the collection, use, and disclosure\n" +
